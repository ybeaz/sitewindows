...
import '../../Shared/stylesTimeAndDate.less';

class AppTimeAndDate extends React.PureComponent {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    ...
    return (
      <div id='clockWrapper' contentEditable={true} className='p_a_0p5_em w_100 h_100 d_t t_a_c'>
        <div id='clock' className='d_t_c v_a_m'>
        </div>
      </div>
    );
  }
}
AppTimeAndDate.propTypes = {
};

export default CommonContainer(AppTimeAndDate)
